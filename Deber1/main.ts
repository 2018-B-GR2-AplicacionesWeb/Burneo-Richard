...
let preguntas_crud = [
    {
        ...
        name:"crud_op",
        message:"Que desea hacer",
        choices: ['Consultar Tipos Juegos','Modificar Juego','Eliminar Juego','Ingresar Juego','salir'],
        validate:(respuesta)=>{
    ...
    inquirer
        ...
        .then(
            (respuestas)=>{
                ...
                let pizza = new Juego(respuestas.clase,size,precio);
                let cantidad = respuestas.cantidad;
                pedido.ordenes.push(new Orden(juego));
